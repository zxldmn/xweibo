...
$(function() {
  var seriesOptions;
  seriesOptions = [];
  $.getJSON('/api/status/status_history', function(data) {
    var appchina_crawled_data, appchina_new_data, appchina_update_data, baidu_crawled_data, baidu_new_data, baidu_update_data, googleplay_crawled_data, googleplay_new_data, googleplay_update_data, hiapk_crawled_data, hiapk_new_data, hiapk_update_data, muzhiwan_crawled_data, muzhiwan_new_data, muzhiwan_update_data, status_list_chart, xiaomi_crawled_data, xiaomi_new_data, xiaomi_update_data;
    xiaomi_crawled_data = [];
    xiaomi_new_data = [];
    xiaomi_update_data = [];
    baidu_crawled_data = [];
    ...
    $.each(data, function(date, item) {
      ...
      item = eval('(' + item + ')');
      $.each(item, function(platform, platform_data) {
        switch (platform) {
          case 'xiaomi':
            if (platform_data.crawled) {
              xiaomi_crawled_data.push([date, parseInt(platform_data.crawled)]);
            }
            if (platform_data["new"]) {
              xiaomi_new_data.push([date, parseInt(platform_data["new"])]);
            }
            if (platform_data.update) {
          ...
          case 'baiduapp':
            ...
            if (platform_data["new"]) {
              baidu_new_data.push([date, parseInt(platform_data["new"])]);
            }
            if (platform_data.update) {
              baidu_update_data.push([date, parseInt(platform_data.update)]);
            }
            break;
          case 'hiapk':
            if (platform_data.crawled) {
              hiapk_crawled_data.push([date, parseInt(platform_data.crawled)]);
            }
            if (platform_data["new"]) {
              hiapk_new_data.push([date, parseInt(platform_data["new"])]);
            }
            if (platform_data.update) {
              hiapk_update_data.push([date, parseInt(platform_data.update)]);
            }
            break;
          case 'appchina':
            if (platform_data.crawled) {
              appchina_crawled_data.push([date, parseInt(platform_data.crawled)]);
            }
            if (platform_data["new"]) {
              appchina_new_data.push([date, parseInt(platform_data["new"])]);
            }
            if (platform_data.update) {
              appchina_update_data.push([date, parseInt(platform_data.update)]);
            }
            break;
          case 'googleplay':
            if (platform_data.crawled) {
              googleplay_crawled_data.push([date, parseInt(platform_data.crawled)]);
            }
            if (platform_data["new"]) {
              googleplay_new_data.push([date, parseInt(platform_data["new"])]);
            }
            if (platform_data.update) {
              googleplay_update_data.push([date, parseInt(platform_data.update)]);
            }
            break;
          case 'muzhiwan':
            if (platform_data.crawled) {
              muzhiwan_crawled_data.push([date, parseInt(platform_data.crawled)]);
            }
            if (platform_data["new"]) {
              muzhiwan_new_data.push([date, parseInt(platform_data["new"])]);
            }
            if (platform_data.update) {
              muzhiwan_update_data.push([date, parseInt(platform_data.update)]);
            }
        }
      });
    });
    ...
    seriesOptions[2] = {
      name: 'xiaomi_update_data',
      data: xiaomi_update_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[3] = {
      name: 'baidu_crawled_data',
      data: baidu_crawled_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[4] = {
      name: 'baidu_new_data',
      data: baidu_new_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[5] = {
      name: 'baidu_update_data',
      data: baidu_update_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[6] = {
      name: 'hiapk_crawled_data',
      data: hiapk_crawled_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[7] = {
      name: 'hiapk_new_data',
      data: hiapk_new_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[8] = {
      name: 'hiapk_update_data',
      data: hiapk_update_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[9] = {
      name: 'appchina_crawled_data',
      data: appchina_crawled_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[10] = {
      name: 'appchina_new_data',
      data: appchina_new_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[11] = {
      name: 'appchina_update_data',
      data: appchina_update_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[12] = {
      name: 'googleplay_crawled_data',
      data: googleplay_crawled_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[13] = {
      name: 'googleplay_new_data',
      data: googleplay_new_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[14] = {
      name: 'googleplay_update_data',
      data: googleplay_update_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[15] = {
      name: 'muzhiwan_crawled_data',
      data: muzhiwan_crawled_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[16] = {
      name: 'muzhiwan_new_data',
      data: muzhiwan_new_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
    seriesOptions[17] = {
      name: 'muzhiwan_update_data',
      data: muzhiwan_update_data.sort(function(x, y) {
        return x[0] - y[0];
      })
    };
      ...
      events: {
        load: function() {
          ...
          setInterval(function() {
            var x;
            x = (new Date()).getTime();
            $.getJSON('/api/status/status_today', function(data) {
              $.each(data, function(platform, platform_data) {
                switch (platform) {
                  case "xiaomi":
